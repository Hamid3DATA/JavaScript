...
function end() {
    if (end_count < 1) {
        ...
        if (your_points > 21 && your_hand_aces === 1 || your_points > 21 && your_hand_aces > 1) {
            while (your_points > 21 && your_hand_aces === 1 || your_points > 21 && your_hand_aces > 1) {
                your_hand_aces -= 1
                your_points -= 10
            }
        }
        ...
        if (dealer_points > 21 && dealer_hand_aces > 0 || dealer_points > 21 && dealer_hand_aces > 1) {
            while (dealer_points > 21 && dealer_hand_aces > 0 || dealer_points > 21 && dealer_hand_aces > 1) {
                dealer_hand_aces -= 1
                dealer_points -= 10
            }
        }
