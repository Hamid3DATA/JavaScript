    ...
    if (end_count < 1) {
        ...
        if (dealer_points === 16 || dealer_points < 16) {
            while (dealer_points === 16 || dealer_points < 16) {
                ...
                if (dealer_hand_aces === 0) {
                    dealer_hand_aces += help
                }

                dealer_points = 0

                while (dealer_hand.length > i) {
                    let dealer_hand_length = dealer_hand.length
                    for (var i = 0; i < dealer_hand_length; i++) {
                        dealer_points += dealer_hand[i][2]
                    }
        ...
        if (your_points === 21 && dealer_points !== 21 || your_points > dealer_points && your_points < 21) {
            won()
            console.log("you won, cuz your_points === 21 && dealer_points !== 21 || your_points > dealer_points && your_points < 21")
        }
        if (your_points < 21 && dealer_points > 21) {
            won()
            console.log("you won, cuz your_points < 21 && dealer_points > 21")
        }
        if (dealer_points === 21 && your_points !== 21 || dealer_points > your_points && dealer_points < 21) {
            loss()
            console.log("you lost, cuz dealer_points === 21 && your_points !== 21 || dealer_points > your_points && dealer_points < 21")
        }
        if (dealer_points < 21 && your_points > 21) {
            loss()
            console.log("you lost, cuz dealer_points < 21 && your_points > 21")
        }
        if (your_points === dealer_points) {
            draw()
            console.log("it's a draw, cuz your_points === dealer_points")
        }
        if (your_points > 21 && dealer_points > 21) {
            draw()
            console.log("it's a draw, cuz your_points > 21 && dealer_points > 21")
        }

        console.log("your points: " + your_points)
        console.log("dealer points: " + dealer_points)
